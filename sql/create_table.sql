...
(
    ...
    language   varchar(50)                        not null comment '提交语言',
...
(
    ...
    uploadNum   int      default 0                 not null comment '题目解题提交数',
    acceptedNum int      default 0                 not null comment '题目通过数',
    judgeConfig varchar(1024)                      not null comment '判题配置(json格式)',
    judgeCase   text                               not null comment '判题测试用例',
    passPercent varchar(50)                        not null comment '题目通过率',
    createTime  datetime default CURRENT_TIMESTAMP not null comment '创建时间',
    updateTime  datetime default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间',
    isDelete    tinyint  default 0                 not null comment '是否删除'
)
